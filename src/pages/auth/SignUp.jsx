    ...
    return (
        <AuthLayout>
            <div className="flex flex-col">
                <h2 className="text-[36px] font-bold text-nav-text mb-2">Sign Up</h2>
                <p className="text-secondary text-base mb-8">Join us and start your journey today!</p>
                ...
                <form className="flex flex-col gap-5" autoComplete="off">
                    ...
                    <button className="w-full bg-primary text-white py-4 rounded-2xl font-bold text-base shadow-[0_20px_40px_-10px_rgba(67,24,255,0.3)] hover:bg-[#3311CC] transition-all transform hover:scale-[1.01] active:scale-[0.99] mt-4">
                        Sign Up
                    </button>
                </form>

                <p className="mt-6 text-sm font-medium text-secondary">
                    Already have an account? <Link to="/signin" className="text-primary font-bold hover:underline">Let's Sign in</Link>
                </p>
            </div>
        </AuthLayout>
    );
